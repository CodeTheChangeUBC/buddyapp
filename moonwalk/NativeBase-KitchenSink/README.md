# INFO
What's been done of the frontend currently lives in this project template and the moonwalk parent directory. This includes:
* login page
* new trip view
* form submit page
* loading page until POST request returns
* buddy found page

This project is currently inside of a Native-base template and can be navigated to by going to the anatomy screen in the app sidebar. You can find all relevant code present under:
* index.js in the Anatomy screen
* full.js in the button screen
...
* clean-up/refactor frontend code and delete templates
* add 2nd form page for more parameters
* complete remaining screens (passcode screen and onwards)
* improve and attach login page to project


The original README information from the Nativebase template can be found below. This code is from the CRNA branch and can be run through the expo app on android or iOS devices.
Dependency configuration will need to be done once this project is built for native use on both systems.
