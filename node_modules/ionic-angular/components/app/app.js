...
export var App = (function () {
    ...
    App.prototype.getActiveNav = function () {
        var /** @type {?} */ portal = this._appRoot._getPortal(MODAL);
        if (portal.length() > 0) {
    ...
    App.prototype.navPop = function () {
        ...
        var /** @type {?} */ portal = this._appRoot._getPortal(DEFAULT);
        if (portal.length() > 0) {
            return Promise.resolve();
        }
...
var /** @type {?} */ DEFAULT = 0; // AppPortal.DEFAULT
var /** @type {?} */ MODAL = 1; // AppPortal.MODAL
