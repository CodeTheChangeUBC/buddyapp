...
export class App {
     ...
     */
    getActiveNav() {
        const /** @type {?} */ portal = this._appRoot._getPortal(MODAL);
        if (portal.length() > 0) {
    ...
    navPop() {
        ...
        const /** @type {?} */ portal = this._appRoot._getPortal(DEFAULT);
        if (portal.length() > 0) {
            return Promise.resolve();
        }
...
const /** @type {?} */ DEFAULT = 0; // AppPortal.DEFAULT
const /** @type {?} */ MODAL = 1; // AppPortal.MODAL
