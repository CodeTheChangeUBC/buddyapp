...
export class Content extends Ion {
    ...
    ngOnInit() {
        if (this._scrollEle)
            return;
        const /** @type {?} */ children = this._elementRef.nativeElement.children;
        (void 0) /* assert */;
    ...
    getContentDimensions() {
        const /** @type {?} */ scrollEle = this._scrollEle;
     ...
     */
    _readDimensions() {
        let /** @type {?} */ cachePaddingTop = this._pTop;
        let /** @type {?} */ cachePaddingRight = this._pRight;
        let /** @type {?} */ cachePaddingBottom = this._pBottom;
        let /** @type {?} */ cachePaddingLeft = this._pLeft;
        let /** @type {?} */ cacheHeaderHeight = this._hdrHeight;
        let /** @type {?} */ cacheFooterHeight = this._ftrHeight;
        let /** @type {?} */ cacheTabsPlacement = this._tabsPlacement;
    ...
    _writeDimensions() {
        ...
        const /** @type {?} */ fixedEle = this._fixedEle;
        if (!fixedEle) {
            (void 0) /* assert */;
            return;
        }
...
function Content_tsickle_Closure_declarations() {
     ...
     * @type {?}
     */
    Content.prototype._scrollEle;
    /**
     * \@internal
     * @type {?}
     */
    Content.prototype._fixedEle;
    /**
     * \@internal
     * @type {?}
     */
