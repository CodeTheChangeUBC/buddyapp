...
/** @private */
export var /** @type {?} */ GESTURE_GO_BACK_SWIPE = 'goback-swipe';
/** @private */
export var /** @type {?} */ GESTURE_MENU_SWIPE = 'menu-swipe';
/** @private */
export var /** @type {?} */ GESTURE_ITEM_SWIPE = 'item-swipe';
/** @private */
export var /** @type {?} */ GESTURE_REFRESHER = 'refresher';
/** @private */
export var /** @type {?} */ GESTURE_TOGGLE = 'toggle';
/**
* @private
*/
export var /** @type {?} */ BLOCK_ALL = {
...
export var GestureController = (function () {
    ...
    GestureController.prototype.capture = function (gestureName, id, priority) {
        ...
        var /** @type {?} */ maxPriority = -10000 /* Minimun */;
