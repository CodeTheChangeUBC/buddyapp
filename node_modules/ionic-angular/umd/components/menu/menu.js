(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../app/app', '../backdrop/backdrop', '../../config/config', '../content/content', '../../platform/dom-controller', '../../gestures/gesture-controller', '../../util/util', '../../platform/keyboard', './menu-gestures', './menu-controller', '../nav/nav', '../../platform/platform', '../../gestures/ui-event-manager', '../split-pane/split-pane'], factory);
    }
