(function (factory) {
    ...
    var col_2 = require('./components/grid/col');
    exports.Col = col_2.Col;
    var grid_2 = require('./components/grid/grid');
    exports.Grid = grid_2.Grid;
    var row_2 = require('./components/grid/row');
    exports.Row = row_2.Row;
    ...
    var split_pane_2 = require('./components/split-pane/split-pane');
    exports.SplitPane = split_pane_2.SplitPane;
    exports.RootNode = split_pane_2.RootNode;
    ...
    var transition_registry_2 = require('./transitions/transition-registry');
    exports.registerTransitions = transition_registry_2.registerTransitions;
    var gesture_config_2 = require('./gestures/gesture-config');
    exports.IonicGestureConfig = gesture_config_2.IonicGestureConfig;
    /**
     * \@name IonicModule
     * \@description
