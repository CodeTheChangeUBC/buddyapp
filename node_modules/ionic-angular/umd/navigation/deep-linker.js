(function (factory) {
    ...
    var DeepLinker = (function () {
        ...
        DeepLinker.prototype.navChange = function (direction) {
            ...
            if (direction) {
                ...
                if (activeNav) {
                    ...
                    var /** @type {?} */ browserUrl = this._serializer.serialize(this.segments);
        ...
        DeepLinker.prototype.getComponentFromName = function (componentName) {
            var /** @type {?} */ segment = this._serializer.createSegmentFromName(componentName);
        ...
        DeepLinker.prototype.createUrl = function (nav, nameOrComponent, data, prepareExternalUrl) {
            ...
            if (segment) {
                var /** @type {?} */ path = this.pathFromNavs(nav, segment.component, data);
        ...
        DeepLinker.prototype.initViews = function (segment) {
            ...
            var /** @type {?} */ view = new view_controller_1.ViewController(segment.component, segment.data);
            view.id = segment.id;
            views.push(view);
            return views;
        };
